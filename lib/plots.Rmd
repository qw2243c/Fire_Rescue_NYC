...
# save(data.raw, file = "dataraw.RData")
# 
...
p = ggplot() + 
  ...
  theme(plot.title = element_text(colour = "black", face = "bold", size = 30, vjust = 1, hjust = 0.5))
...
```{r FirstSeenANDClosingTime, out.width= 1800, out.height= 1000}
